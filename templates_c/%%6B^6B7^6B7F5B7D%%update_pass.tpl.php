<?php /* Smarty version 2.6.27, created on 2012-11-07 08:30:37
    ...
    <div id="main"> 
      ...
      <div class="op" style="margin-left:20px;">
        <form method="POST" action="">
          <table>
            <tr><td class="m">账号:</td><td class="left"><input type="text" id="consumer" name="consumer" value="<?php echo $_COOKIE['consumer']; ?>
