<?php /* Smarty version 2.6.27, created on 2012-11-06 14:16:38
         compiled from manage_job.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'manage_job.tpl', 1, false),array('modifier', 'truncate', 'manage_job.tpl', 29, false),)), $this); ?>
...
" />
          <tr><td class="m">公司名称:</td><td><?php echo $this->_tpl_vars['job']['company_name']; ?>
</td></tr>
          <tr><td class="m">职位名称:</td><td><input type="text" id="job_name" name="job_name" value="<?php echo $this->_tpl_vars['job']['job_name']; ?>
" /></td></tr>
          <tr><td class="m">职位信息:</td><td><textarea id="job_meta" name="job_meta"><?php echo $this->_tpl_vars['job']['job_meta']; ?>
</textarea></td></tr>
