<?php /* Smarty version 2.6.27, created on 2012-11-06 13:24:39
      ...
      <div class="op" style="margin-left:20px;">
        <form method="POST">
          ...
          <?php if ($this->_tpl_vars['user_type'] == 0): ?>
            <tr><td class="m">部门名称:</td><td><input type="text" name="department_name" readonly="true" value="<?php echo $this->_tpl_vars['account']['department_name']; ?>
"/></td></tr>
          ...
          <?php if ($this->_tpl_vars['user_type'] == 1): ?>
            <tr><td class="m">照片:</td><td><img src="<?php echo $this->_tpl_vars['account']['pic_path']; ?>
" width="60" height="80" /></td></tr>
            <tr><td class="m">姓名:</td><td><input type="text" name="name" value="<?php echo $this->_tpl_vars['account']['name']; ?>
" /></td></tr>
            ...
            <tr><td class="m">身份证号:</td><td><input type="text" name="id_num" value="<?php echo $this->_tpl_vars['account']['id_num']; ?>
" /></td></tr>
            <tr><td class="m">年级:</td><td><input type="text" name="grade" value="<?php echo $this->_tpl_vars['account']['grade']; ?>
" /></td></tr>
            <tr><td class="m">专业:</td><td><input type="text" name="major" value="<?php echo $this->_tpl_vars['account']['major']; ?>
" /></td></tr>
            <tr><td class="m">联系电话:</td><td><input type="text" name="contact_num" value="<?php echo $this->_tpl_vars['account']['contact_num']; ?>
" /></td></tr>
            <tr><td class="m">家庭成员关系:</td><td><button id="show-family" class="btn btn-link">修改成员关系</button></td></tr>
            <tr><td class="m">备注:</td><td><textarea name="extra"><?php echo $this->_tpl_vars['account']['extra']; ?>
</textarea></td></tr>
          ...
          <?php if ($this->_tpl_vars['user_type'] == 2): ?>
            <tr><td class="m">公司名称:</td><td><input type="text" name="company_name" value="<?php echo $this->_tpl_vars['account']['company_name']; ?>
"/></td></tr>
            <tr><td class="m">公司描述:</td><td><textarea name="meta_info"><?php echo $this->_tpl_vars['account']['meta_info']; ?>
</textarea></td></tr>
